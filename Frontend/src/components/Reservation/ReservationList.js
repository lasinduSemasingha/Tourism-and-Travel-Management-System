...
import { Card, CardContent, Typography, Button, Grid, TextField, Select, MenuItem } from '@mui/material';
            ...
            <Grid container spacing={3}>
                {reservations.map(reservation => (
                    <Grid item xs={12} sm={6} md={4} key={reservation._id}>
                        <Card>
                            <CardContent>
                                <Typography variant="h5">{reservation.destinationId.name}</Typography>
                                <Typography variant="body1">Location: {reservation.destinationId.location}</Typography>
